...
<tr><td>电子邮箱：
	...
	<td><input type="text">*
	<tr><td>性取向：
	<td><input type="radio" name=“性取向” value=“boy”>男
	<input type="radio" name=“性取向” value=“girl”>女
	<input type="radio" name=“性取向” value=“boy and girl”>双向
	   <td>次选项为非必填
	<tr><td>是否为单身
		<td><input type="radio" name=“单身” value="yes">是
		<input type="radio" name=“单身” value="no">不是
